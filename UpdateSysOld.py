...
print(bcolors.yellow + bcolors.bold + "Warning: This script is not always fully automated!\nThis script uses apt like \"apt-get install\". If you would like to use apt like \"apt install\" please use the new/current version of this script." + bcolors.reset)
...
os.system("sudo apt-get update " + usrInput)
print(bcolors.purple + "Running Upgrade" + bcolors.reset)
os.system("sudo apt-get upgrade " + usrInput)
print(bcolors.purple + "Running Update" + bcolors.reset)
os.system("sudo apt-get update " + usrInput)
print(bcolors.purple + "Running Upgrade" + bcolors.reset)
os.system("sudo apt-get upgrade " + usrInput)
